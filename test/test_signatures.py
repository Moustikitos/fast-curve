...
from cSecp256k1 import ecdsa, _ecdsa
from cSecp256k1 import schnorr, _schnorr
...
rfc6979_k = b"%64x" % ecdsa.rfc6979_k(unhexlify(msg), unhexlify(pr_key))[0]
k = b"%64x" % ecdsa.rand_k()
